...
def test(data_loader):
    ...
    for img, segm, img_id in tqdm(data_loader):
        ...
        for type in type_list: 
            ...
            print(submission.loc[submission['ImageId_ClassId']==img_id[0]+'_'+str(type), 'EncodedPixels'].values)
            submission.loc[submission['ImageId_ClassId']==img_id[0]+'_'+str(type), 'EncodedPixels'].values[0] = rle
